...
void show_choose_zip_menu(const char *mount_point)
{
    ...
    static char* headers[] = {  "选择一个ZIP压缩包安装",
                                "",
                                NULL
    };
...
int control_usb_storage_for_lun(Volume* vol, bool enable) {
    static const char* lun_files[] = {
        ...
        "/sys/class/android_usb/android0/f_mass_storage/lun2/file",
        NULL
    };
...
void show_mount_usb_storage_menu()
{
    ...
    static char* list[] = { "卸载USB大容量存储", NULL };
...
void show_nandroid_advanced_restore_menu(const char* path)
{
    ...
    static char* advancedheaders[] = {  "选择一个镜像来还原",
                                "",
                                "首先选择一个镜像",
                                "在接下来的菜单中",
                                "将会显示更多的选项",
...
void show_advanced_menu()
{
    ...
    for (;;)
    {
	    ...
	    case 2:
            {
                if (confirm_selection( "确认清空？", "是 - 清空电量信息"))
                    wipe_battery_stats();
                break;
	    }
            case 3:
