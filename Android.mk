...
ifdef RECOVERY_FLAG_BLOCK
  LOCAL_CFLAGS += -DRECOVERY_FLAG_BLOCK=$(RECOVERY_FLAG_BLOCK)
else
  LOCAL_CFLAGS += -DRECOVERY_FLAG_BLOCK=0
endif
...
RECOVERY_VERSION := $(RECOVERY_NAME) v6.0.2.8 by安智ATX团队
